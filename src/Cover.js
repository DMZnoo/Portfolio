...
const Cover = ({ onClick }) => {
  ...
  const SlideOutUp = styled.div`
    animation: 2s ${keyframes`${slideOutUp}`} 1;
  `;
  const SlideOutDown = styled.div`
    animation: 2s ${keyframes`${slideOutDown}`} 1;
  `;
    ...
    <div className="ui segments">
      ...
      <div className="ui segment grid choices" style={{ border: "none" }}>
        ...
        <div className="ui segment grid choices" style={{ border: "none" }}>
          ...
          >
            <i className="right arrow icon"></i>Front/Back-end Developer
          </DelayLink>
          <DelayLink
            to={{
              pathname: "/about",
            ...
            style={{ width: "auto", fontSize: "1em" }}
          >
            <i className="right arrow icon"></i>Software Engineer
          </DelayLink>
          <DelayLink
            to={{
              pathname: "/about",
            ...
            style={{ width: "auto", fontSize: "1em" }}
          >
            <i className="right arrow icon"></i>Machine Learning Engineer
          </DelayLink>
        </div>
      </div>
      {isButtonClicked.transition && (
