...
const Intro = () => {
  ...
  const SlideIn = styled.div`
    animation: 2s ${keyframes`${slideInLeft}`} 1;
  `;
      ...
      <div className="ui center aligned segment">
        ...
        <div className="content">
          ...
          {isProfession === "web" && (
            <div>
              <h3>
                I am a Full Stack Developer currently residing in Auckland,NZ
              </h3>
              <h3>
                ...
                Design Practices and writing{" "}
                <span className="container graphics">Quality</span>
                <span> Code</span>
              </h3>
            </div>
          )}
          {isProfession === "software" && (
            <div>
              <h3>
                I am a Software Engineer currently residing in Auckland,NZ
              </h3>
              <h3>
                I am passionate about
                <span className="container">
                ...
                Programming and{" "}
                <span className="container graphics">GRAPHICS</span>
          ...
          {isProfession === "ml" && (
            <div>
              <h3>
                I am a Machine Learning Engineer currently residing in
                Auckland,NZ
              </h3>
              <h3>
                I am passionate about
                ...
                <span className="container graphics">Scalable</span>
