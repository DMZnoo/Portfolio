      ...
      <main className="pt-24 lg:w-1/2 lg:py-24">
        <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="About me">
          ...
          <div className="text-slate-400">
            ...
            <p className="mb-4">
            After the service, I came to New Zealand to study computer science and after a year of study, I was able to find an internship and started my early career as a software engineer. 
            Ever since then, I had a privilege to work in an early stage <Link href="https://www.myclearhead.com" target="_blank" rel="noreferrer noopener" className="text-primary-200">start up</Link>, a <Link href="https://datacom.com/" target="_blank" rel="noreferrer noopener" className="text-primary-200">large corporation</Link>, and lately a <Link href="https://ionprotocol.io/" target="_blank" rel="noreferrer noopener" className="text-primary-200">crypto start up</Link> based in Philadelphia.
            </p>
